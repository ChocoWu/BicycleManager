...
public class AddCzy extends JPanel {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				if (name.getText() == null || name.getText().equals("")) {
					JOptionPane.showMessageDialog(AddCzy.this, "用户名不能为空");
					name.setRequestFocusEnabled(true);
					return;
				}
				if (passwordField.getPassword().length == 0) {
					JOptionPane.showMessageDialog(AddCzy.this, "密码不能为空");
					...
					JOptionPane.showMessageDialog(AddCzy.this, "操作员添加成功");
					clear();
				} else {
					JOptionPane
							.showMessageDialog(AddCzy.this, "两次密码输入不相同");
				}
			}
		});
		button.setText("添加");
